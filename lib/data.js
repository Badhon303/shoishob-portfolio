...
import cafe from "@/public/maraetai.png"
import reginest from "@/public/reginest.png"
import nakhlah from "@/public/nakhlah.png"
...
export const projectsData = [
  ...
  },
  {
    title: "Maraetai Cafe",
    description:
      "Cafe platform with dynamic menus and real-time reservation system, streamlining online bookings and customer engagement.",
    tags: ["React.js", "Django", "REST API", "PostgreSQL", "TailwindCSS"],
    imageUrl: cafe,
    liveDemoUrl: "https://maraetaicafe.co.nz/",
    repoUrl: "https://github.com/Shoishob007/Cafe-Marataee.git"
  },
  {
  ...
  {
    title: "RegiNest Trade Platform",
    description: "B2B trade platform with SSLCommerz payment integration, enabling secure business transactions and product management.",
    tags: ["React.js", "SSLCommerz", "MongoDB", "TailwindCSS", "Express.js"],
    imageUrl: reginest,
    liveUrl: "https://reginest-web-gamma.vercel.app/",
  },
    {
    title: "Nakhlah",
    description: "An Arabic language learning platform that offers interactive lessons, challenges, and progress tracking to make mastering Arabic language fun and rewarding.",
    tags: ["React.js", "Nest.js", "Redux Toolkit", "Zustand", "TailwindCSS"],
    imageUrl: nakhlah,
    liveUrl: "https://nakhlah-lms-test.vercel.app/",
  },
  {
    title: "E-Commerce",
    description:
